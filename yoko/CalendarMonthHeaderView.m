...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 0.0f, 50.0f, 30.f)];
    ...
    //年
    UILabel *subLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 20.0f, 50.0f, 20.f)];
    [subLabel setBackgroundColor:[UIColor clearColor]];
    [subLabel setTextAlignment:NSTextAlignmentCenter];
    [subLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:10.0f]];
