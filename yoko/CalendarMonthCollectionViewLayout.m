...
- (instancetype)init
{
    self = [super init];
    if (self) {
        self.headerReferenceSize = CGSizeMake(320.0f, 50.0f);//头部视图的框架大小
        
        self.itemSize = CGSizeMake(50, 50);//每个cell的大小
        
        self.minimumLineSpacing = 0;//每行的最小间距
        
        self.minimumInteritemSpacing = 0;//每列的最小间距
        
        self.sectionInset = UIEdgeInsetsMake(0, 0, 9, 9);//网格视图的/上/左/下/右,的边距
    }
