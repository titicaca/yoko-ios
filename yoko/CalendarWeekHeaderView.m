...
@interface CalendarWeekHeaderView ()

@end



@implementation CalendarWeekHeaderView
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.f, -5.0f, 50.0f, 30.f)];
    [masterLabel setBackgroundColor:[UIColor clearColor]];
    [masterLabel setTextAlignment:NSTextAlignmentCenter];
    [masterLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:20.0f]];
    self.masterLabel = masterLabel;
    self.masterLabel.textColor = COLOR_THEME;
    [self addSubview:self.masterLabel];
    
    //年
    UILabel *subLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.f, 15.0f, 50.0f, 20.f)];
    [subLabel setBackgroundColor:[UIColor clearColor]];
    [subLabel setTextAlignment:NSTextAlignmentCenter];
    [subLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:12.0f]];
    self.subLabel = subLabel;
    self.subLabel.textColor = COLOR_THEME;
